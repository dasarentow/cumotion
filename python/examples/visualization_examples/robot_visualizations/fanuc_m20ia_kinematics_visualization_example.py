...
"""This example demonstrates how to visualize a Fanuc M20-iA arm."""
...
import cumotion
try:
    from cumotion_vis.visualizer import (
        FanucM20iAVisualization,
        Visualizer,
        CollisionSphereVisualization,
    )
except ImportError:
...
if __name__ == '__main__':
    ...
    # Set absolute path to URDF file for the Fanuc M20-iA.
