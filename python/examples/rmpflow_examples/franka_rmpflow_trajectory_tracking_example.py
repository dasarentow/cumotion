...
if __name__ == '__main__':
    ...
    # Set end effector target. The other optional arguments (for setting orientation and default
    # c-space configuration) are not used for this task.
    rmpflow.set_end_effector_position_attractor(translation_target)
    ...
    # it to back up and and enter the table from below.
    ...
    print("Final joint position: ", joint_position)
    ...
    if planning_results.path_found:
        ...
        for q_target in planning_results.path:
            ...
            x_pose = kinematics.pose(joint_position, tool_frame_name)
